...
The user you are trying to impersonate doesn't exist, or the B2 experienced an issue binding your current session to the desired user. If you are sure that the user exists, logging out and back in again may fix the problem. If the issue persists, the [log file](usage/accessing-logs.md) might be of use to you.
